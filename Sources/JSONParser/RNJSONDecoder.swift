// Last sync: https://github.com/apple/swift-corelibs-foundation/blob/9c4cec91fe344dd25c23aa1971eb36f926bfcaf4/Sources/Foundation/JSONDecoder.swift
...
fileprivate struct JSONDecoderImpl {
    ...
    init(userInfo: [CodingUserInfoKey: Any], from json: JSONValue, codingPath: [CodingKey], options: RNJSONDecoder._Options) {
        ...
        init(impl: JSONDecoderImpl, codingPath: [CodingKey], dictionary: [String: JSONValue]) {
            ...
            case .convertFromSnakeCase:
                ...
                dictionary.forEach { (key, value) in
                    converted[RNJSONDecoder.KeyDecodingStrategy._convertFromSnakeCase(key)] = value
                }
