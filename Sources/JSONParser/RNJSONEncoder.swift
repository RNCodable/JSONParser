// Last sync: https://github.com/apple/swift-corelibs-foundation/blob/9c4cec91fe344dd25c23aa1971eb36f926bfcaf4/Sources/Foundation/JSONEncoder.swift
...
private protocol _SpecialTreatmentEncoder {
    ...
    var options: RNJSONEncoder._Options { get }
...
private struct JSONKeyedEncodingContainer<K: CodingKey>: KeyedEncodingContainerProtocol, _SpecialTreatmentEncoder {
    ...
    fileprivate var options: RNJSONEncoder._Options {
...
extension JSONValue {
    ...
    fileprivate struct Writer {
        let options: RNJSONEncoder.OutputFormatting

        init(options: RNJSONEncoder.OutputFormatting) {
            self.options = options
        }
